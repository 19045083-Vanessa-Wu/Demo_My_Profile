package sg.edu.rp.c346.id19045083.demomyprofile;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onPause() {
        ...
        SharedPreferences.Editor prefEditName = prefs.edit();
        SharedPreferences.Editor prefEditGPA = prefs.edit();

        // Step 1d: Add the key-value pair
        prefEditName.putString("Name", strName);
        prefEditGPA.putFloat("GPA", fgpa);
    ...
    protected void onResume() {
        ...
        String SetName = prefs.getString("Name", "User");
        Float SetGPA = prefs.getFloat("GPA", 0);

        // Step 2c: Updated the UI element with the value
        etName.setText(SetName);
        etGPA.setText(SetGPA.toString());
    }
}